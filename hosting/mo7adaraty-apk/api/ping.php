...
if ($method === 'POST') {
    ...
    // توافق محدود مع استضافات مجانية تعرض تحقق JavaScript لطلبات POST من تطبيقات الهاتف.
    // هذا المسار لا يقبل رمز Expo Push ولا يفعل الإشعارات؛ يسجل نبضة تثبيت مجهولة فقط.
    $input = [
        'installationId' => $_GET['i'] ?? '',
        'versionCode' => $_GET['v'] ?? null,
...
api_json(['ok' => true, 'transport' => $method === 'GET' ? 'compatibility_beacon' : 'post']);
